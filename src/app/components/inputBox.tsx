    ...
    return (
        <textarea
            ...
            className={`border border-[var(--border_color)] rounded-lg mb-4 
                ...
                ring-1 ring-white/5
                text-[var(--loading_color)] placeholder:text-slate-500 
                hover:bg-white hover:shadow-[0_0_40px_rgba(77,168,190,0.35)] 
                shadow-[0_0_8px_rgba(34,211,238,0.3)] ${sizeClasses[size]}`}>
        </textarea>
    )
}
